      ...
      <main className="flex-1">
        <section className="mx-auto max-w-6xl px-6 py-24">
          <div className="max-w-xl">
            <p className="text-[12.5px] font-medium uppercase tracking-[0.08em] text-muted">Pricing</p>
            <h1 className="font-heading mt-3 text-balance text-3xl font-medium tracking-tight text-ink sm:text-4xl">
              Flow charges only when you get paid.
            </h1>
          ...
          <div className="relative z-0 mt-10 overflow-hidden rounded-2xl bg-ink px-6 py-14 sm:px-10 sm:py-16">
            <RepelDotGrid />
            <div className="relative z-10 flex flex-col items-start gap-10 sm:flex-row sm:items-center sm:justify-between">
              <div className="max-w-md">
                <span className="text-[11px] font-semibold tracking-[0.1em] text-background/60">FLOW</span>
              ...
              <div className="shrink-0 rounded-2xl border border-background/15 bg-background/5 px-8 py-6 text-center">
                <p className="font-heading tabular-nums text-6xl font-medium text-background">2%</p>
